...
from config import (
    ...
    ENABLE_METRICS, ENABLE_LLM, LLM_TEMPERATURE, TEST_PERCENTAGE, TEST_MODE,
...
def build_llm_prompt_compact(nombres_pro_lista: List[str]) -> Tuple[str, Dict[str, str]]:
    ...
    prompt_txt = """Experto en SPA en Colombia. Clasifica en UNA O MÁS categorías SOLAMENTE si hay evidencia explícita.
